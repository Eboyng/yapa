<div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-purple-50">
    ...
    @if ($showCreateModal)
        ...
        <div class="fixed inset-0 z-50 overflow-hidden sm:hidden" aria-labelledby="mobile-create-modal-title"
            ...
            <div
                class="fixed bottom-0 left-0 right-0 bg-white rounded-t-2xl transform transition-transform duration-300 ease-in-out max-h-[115vh] overflow-hidden">
                            ...
                            <!-- Niche -->
                             <div>
                                 <label for="mobile-niche"
                                     class="block text-xs font-medium text-gray-700 mb-1">Niche *</label>
                            ...
                            <!-- Follower Count -->
                             <div>
                                 <label for="mobile-follower-count"
                                     class="block text-xs font-medium text-gray-700 mb-1">Followers *</label>
                             ...
                             <div class="mt-1 flex justify-center px-4 pt-4 pb-4 border-2 border-gray-300 border-dashed rounded-lg">
                                 <div class="space-y-1 text-center">
                                     @if ($sample_screenshot)
                                         <div class="mb-3">
                                             <img src="{{ $sample_screenshot->temporaryUrl() }}" class="mx-auto h-16 w-auto rounded-lg shadow-md">
                                             <button type="button" wire:click="$set('sample_screenshot', null)" class="mt-2 text-xs text-red-600 hover:text-red-800">
                                                 Remove
                                             </button>
                                         </div>
                                     @else
