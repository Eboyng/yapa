<div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-purple-50">
        ...
        <div class="flex justify-end">
            <div class="flex items-center gap-3">
                <div class="">
                    ...
                    <a href="{{ route('channel-bookings.index') }}"
                        class="flex gap-2 items-center bg-purple-600 text-white rounded-xl text-sm shadow px-4 py-2">
                    ...
                    <div
                        ...
                        <div class="p-4 sm:p-6 flex-1">
                            ...
                            <div class="flex items-start justify-between mb-4">
                                ...
                                @endphp
                                <span
                                    class="flex-shrink-0 ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $statusColors[$ad->status] ?? 'bg-gray-100 text-gray-800' }}">
                                    {{ ucfirst($ad->status) }}
                                </span>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-3 mb-4">
                                <div class="flex items-center text-sm">
                                    <svg class="w-4 h-4 mr-2 text-green-500 flex-shrink-0" fill="none"
                                    ...
                                    <span
                                        class="font-medium text-green-600">₦{{ number_format($ad->payment_per_channel) }}</span>
                                </div>
        ...
        @else
            ...
            <div class="text-center py-16">
                ...
                <p class="text-gray-600 mb-6 max-w-md mx-auto">
                    We couldn't find any ads matching your criteria. Try adjusting your filters to discover more
                    opportunities.
                </p>
            </div>
        @endif
    ...
    <!-- Filter Modal -->
    <div id="filterModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="modal-title"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search"
                            placeholder="Search by title or description..." id="search"
                    ...
                    <div>
                        ...
                        <select wire:model.live="nicheFilter" id="niche"
                            class="w-full rounded-xl border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <select wire:model.live="locationFilter" id="location"
                            class="w-full rounded-xl border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 transition-colors duration-200">
                    ...
                    <div>
                        ...
                        <select wire:model.live="budgetFilter" id="budget"
                            class="w-full rounded-xl border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500 transition-colors duration-200">
