<div class="min-h-screen bg-gradient-to-br from-orange-50 via-white to-purple-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div class="text-center mb-8">
            <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-orange-500 to-purple-500 rounded-2xl flex items-center justify-center">
            ...
            <p class="mt-2 text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">
                Top up your account with credits to join batches and access premium features
            </p>
            
            @if($retryTransactionId)
                <div class="mt-6 mx-auto max-w-md bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-xl p-4 animate-fade-in">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Retrying Failed Transaction</h3>
                            <p class="mt-1 text-sm text-yellow-700">You are retrying a previously failed payment. The amount has been pre-filled.</p>
                        </div>
                    </div>
                </div>
            @endif
        ...
        <!-- Current Balance -->
        <div class="bg-gradient-to-r from-orange-500 to-purple-600 rounded-2xl p-6 mb-8 text-white shadow-lg hover:shadow-xl transition-shadow duration-300">
        ...
        <!-- Pricing Information -->
        <div class="bg-gradient-to-r from-orange-50 to-purple-50 border border-orange-200 rounded-2xl p-4 sm:p-6 mb-8">
            <div class="flex items-start">
                <div class="flex-shrink-0">
                ...
                <div class="ml-4 flex-1">
                    <h3 class="text-sm font-semibold text-gray-900">Pricing Information</h3>
                ...
                @foreach($packages as $index => $package)
                    <div class="relative">
                        ...
                        <label for="package-{{ $index }}" 
                               class="block p-4 border-2 rounded-2xl cursor-pointer transition-all duration-300 transform hover:scale-105
                            ...
                            @if($package['bonus'] > 0)
                                <div class="absolute -top-2 -right-2 bg-gradient-to-r from-green-500 to-green-600 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg animate-pulse">
                                    +{{ $package['bonus'] }} Bonus
                                </div>
                            @endif
                            
                            <div class="text-center">
                                <div class="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-orange-600 to-purple-600 bg-clip-text text-transparent">
                                    {{ number_format($package['credits']) }}
                                </div>
                                <div class="text-sm text-gray-500">Credits</div>
                                
                                @if($package['bonus'] > 0)
                                    <div class="text-xs text-green-600 font-medium mt-2 bg-green-50 rounded-lg py-1">
                                        + {{ $package['bonus'] }} Bonus = {{ number_format($package['total_credits']) }} Total
                                    </div>
                                @endif
                                
                                <div class="mt-3 text-xl sm:text-2xl font-bold text-gray-900">
