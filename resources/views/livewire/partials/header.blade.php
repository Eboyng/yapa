        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-14 sm:h-16">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ auth()->check() ? route('home') : route('channel-sale.browse') }}" class="flex items-center space-x-2 sm:space-x-3 group">
                ...
                <nav class="hidden lg:flex items-center space-x-1">
                    ...
                    <a href="{{ route('channel-sale.browse') }}" class="flex items-center space-x-2 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-200 hover:bg-orange-50 {{ request()->routeIs('channel-sale.*') ? 'text-orange-600 bg-orange-50' : 'text-gray-700 hover:text-orange-600' }}">
                ...
                <div class="flex items-center space-x-2 sm:space-x-3">
                    ...
                    @else
                        ...
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('login') }}" class="px-3 py-2 text-sm font-medium text-gray-700 hover:text-orange-600 transition-colors">
                                Login
                            </a>
                            <a href="{{ route('register') }}" class="px-4 py-2 bg-gradient-to-r from-orange-500 to-purple-500 text-white text-sm font-medium rounded-xl hover:from-orange-600 hover:to-purple-600 transition-all duration-200 shadow-lg hover:shadow-xl">
                                Sign Up
                            </a>
                        </div>
                    @endauth
                    ...
                    <div class="relative" x-data="{ open: false }" @keydown.escape.window="open = false">
                        ...
                        <div x-show="open"
                            ...
                            <div class="py-2 border-b border-gray-100 lg:hidden">
                                ...
                                <a href="{{ route('channel-sale.browse') }}" class="flex items-center px-4 py-2 text-sm  transition-colors {{ request()->routeIs('channel-sale.*') ? 'bg-orange-50 text-orange-600' : 'text-gray-700 hover:bg-orange-50 hover:text-orange-600' }}">
