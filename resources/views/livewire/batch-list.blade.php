                                    ...
                                    <div class="flex items-center p-2 gap-3 justify-between">
                                        <div class="">
                                            <div class="bg-white bg-opacity-20 rounded-full animate-pulse-slow">
                                                <svg class="w-10 h-10 md:w-20 md:h-20 text-white" fill="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path
                                        ...
                                        <div class="">
                                            <div class="mb-1">
                                                <h1 class="text-lg md:text-4xl lg:text-5xl font-bold  animate-fade-in-up"
                                                    x-data="typewriter('{{ $this->settingService->get('banner_auth_title', 'Join Our WhatsApp Community') }}')" x-text="displayText"></h1>

                                                <p class="text-sm md:text-xl lg:text-2xl animate-fade-in-up animation-delay-300 opacity-90"
                                            ...
                                            <div class="animate-fade-in-up animation-delay-900">
                                                <a href="{{ $this->settingService->get('banner_auth_button_url', 'https://chat.whatsapp.com/your-group-link') }}"
                                                    target="_blank"
                                                    class="bg-white text-green-600 px-5 py-2 rounded-full font-semibold text-sm hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-sm hover:shadow-lg inline-flex items-center gap-3">
