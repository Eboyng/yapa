    ...
    <div class="py-4 sm:py-8 lg:py-12">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div class="bg-white border border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
                <div class="border-b border-gray-100 p-4 sm:p-6 cursor-pointer" wire:click="$toggle('showProfileInfo')">
                    <div class="flex items-center justify-between">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200 {{ $showProfileInfo ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Security Settings -->
            <div class="bg-white border border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
                <div class="border-b border-gray-100 p-4 sm:p-6 cursor-pointer" wire:click="$toggle('showSecuritySettings')">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200 {{ $showSecuritySettings ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </div>
                </div>
            ...
            <!-- WhatsApp Settings -->
            <div class="bg-white border border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
                <div class="border-b border-gray-100 p-4 sm:p-6 cursor-pointer" wire:click="$toggle('showWhatsAppSettings')">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200 {{ $showWhatsAppSettings ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </div>
                </div>
            ...
            <!-- Google Integration -->
            <div class="bg-white border border-gray-100 rounded-xl sm:rounded-2xl overflow-hidden">
                <div class="border-b border-gray-100 p-4 sm:p-6 cursor-pointer" wire:click="$toggle('showGoogleIntegration')">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                        ...
                        <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200 {{ $showGoogleIntegration ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                        </svg>
                    </div>
                </div>
